...
<ol>
    <li>1. Put <a href="nice_ui.h">nice_ui.h</a> in your project's include folder.</li>
    <li>2. Add #define NICE_UI_IMPLEMENTATION <b>before</b> using #include "nice_ui.h".</li>
    <li>3. Create a context with New_Context().</li>
</ol>
